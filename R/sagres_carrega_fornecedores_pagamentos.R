...
carrega_licitacoes_por_fornecedor <- function(ano_inicial = 2014, ano_final = 2014, lista_cnpjs) {
    empenhos <- carrega_empenhos(ano_inicial, ano_final, lista_cnpjs)
...
carrega_contratos_por_licitacao_e_fornecedor <- function(ano_inicial = 2014, ano_final = 2014) {
    sagres <- dbConnect(RMySQL::MySQL(),
                        dbname = "sagres_municipal",
                        group = "ministerio-publico",
                        username = "shiny")
